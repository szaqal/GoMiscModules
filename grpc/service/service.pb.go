...
func init() {
	proto.RegisterType((*InParams)(nil), "service.InParams")
...
var fileDescriptor_a0b84a42fa06f626 = []byte{
	...
	0x38, 0x3c, 0xf3, 0x02, 0x12, 0x8b, 0x12, 0x73, 0x8b, 0x85, 0xf8, 0xb8, 0x98, 0x32, 0x53, 0x24,
	0x18, 0x15, 0x18, 0x35, 0x58, 0x83, 0x98, 0x32, 0x53, 0x94, 0xac, 0xb9, 0xf8, 0x83, 0x21, 0xca,
	0x82, 0x52, 0x8b, 0x0b, 0xf2, 0xf3, 0x8a, 0x53, 0xd1, 0x95, 0x08, 0x49, 0x70, 0xb1, 0x17, 0x97,
	0x26, 0x27, 0xa7, 0x16, 0x17, 0x4b, 0x30, 0x29, 0x30, 0x6a, 0x70, 0x04, 0xc1, 0xb8, 0x46, 0xee,
	0x5c, 0xdc, 0xc1, 0xf9, 0xb9, 0xa9, 0x50, 0x03, 0x84, 0x2c, 0xb8, 0xd8, 0x0b, 0x52, 0x8b, 0xd2,
	0xf2, 0x8b, 0x72, 0x85, 0x04, 0xf5, 0x60, 0x6e, 0x81, 0xd9, 0x2c, 0x25, 0x01, 0x17, 0x42, 0xb3,
	0x50, 0x89, 0x21, 0x89, 0x0d, 0xec, 0x62, 0x63, 0x40, 0x00, 0x00, 0x00, 0xff, 0xff, 0x53, 0xc9,
	0x62, 0x43, 0xc2, 0x00, 0x00, 0x00,
}
...
type SomeServiceClient interface {
	Perform(ctx context.Context, in *InParams, opts ...grpc.CallOption) (*ServiceResponse, error)
}
...
func (c *someServiceClient) Perform(ctx context.Context, in *InParams, opts ...grpc.CallOption) (*ServiceResponse, error) {
...
type SomeServiceServer interface {
	Perform(context.Context, *InParams) (*ServiceResponse, error)
}
...
func (*UnimplementedSomeServiceServer) Perform(ctx context.Context, req *InParams) (*ServiceResponse, error) {
...
func _SomeService_Perform_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SomeServiceServer).Perform(ctx, req.(*InParams))
	}
